...
public class CarC_display extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_cdisplay);
        ...
        requestnode = node.child("carC_LCD");

        if (getIntent().getStringExtra("CarConnected").equals("B")) {
            displaynode = node.child("carB_LCD_Msg");
        } else if (getIntent().getStringExtra("CarConnected").equals("A")) {
        ...
        connectionnode.addValueEventListener(new ValueEventListener() {
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (((String) dataSnapshot.getValue(String.class)).equals("0")) {
                    Intent i = new Intent(CarC_display.this, CarC_Home.class);
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(CarC_display.this, "Connection Error", Toast.LENGTH_SHORT).show();
            }
        });
        displayselfnode = node.child("carC_LCD_Msg");
