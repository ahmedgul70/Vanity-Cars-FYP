...
public class CarC_details_page extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_cdetails_page);
        ...
        displaySelfnode = node.child("carC_LCD");
        ...
        yesbtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                displaynode.setValue("C");
                Intent i = new Intent(CarC_details_page.this, CarC_display.class);
        ...
        this.nobtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                requestnode.setValue("0");
                startActivity(new Intent(CarC_details_page.this, CarC_Home.class));
                finish();
            }
        });
