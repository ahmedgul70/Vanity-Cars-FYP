...
public class CarD_display extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_ddisplay);
        ...
        requestnode = node.child("carD_LCD");
        ...
        connectionnode.addValueEventListener(new ValueEventListener() {
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (((String) dataSnapshot.getValue(String.class)).equals("0")) {
                    Intent i = new Intent(CarD_display.this, CarD_Home.class);
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(CarD_display.this, "Connection Error", Toast.LENGTH_SHORT).show();
            }
        });
        displayselfnode = node.child("carD_LCD_Msg");
